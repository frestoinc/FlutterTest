...
class JsonContent extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _JsonContentState();
}

class _JsonContentState extends State<JsonContent> implements DialogListener {
  HomeBloc _homeBloc;
